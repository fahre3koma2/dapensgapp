        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">Laporan Anak Sudah Bekerja</h1>
              <ol class="breadcrumb">
                <li><a href="index.html">Layanan</a></li>
                <li class="active">Laporan Anak Sudah Bekerja</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="payment-form">
          <form action="{{ route('laporankirim') }}" method="POST" >
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-field">
                  ...
                  <input name="nama_pelapor" type="text" required>
                   <input name="kode" type="hidden" value="AB-">
              ...
              <div class="col-md-6">
                <div class="form-field">
                  <label>Tanggal Mulai Bekerja<span class="red">*</span></label>
