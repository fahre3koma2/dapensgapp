...
@section('breadcrumb')
    <div class="content-header sty-one">
      <h1>Permohonan Pembayaran Manfaat Pensiun Anak</h1>
      <ol class="breadcrumb">
        <li><a href="#">Pemohonan</a></li>
        <li><i class="fa fa-angle-right"></i>Permohonan Pembayaran Manfaat Pensiun Anak</li>
      </ol>
    </div>
@endsection
                ...
                <table id="example2" class="table table-bordered table-hover" data-name="cool-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item->status == 1)
                                <a href="{!! route('admin.permohonan.verifikasi', ['id' => encrypt($item->id) , 'jenis' => 'anak']) !!}" type="button" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Verifikasi </a>
                                @else
