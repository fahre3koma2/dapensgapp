            ...
            <div class="row m-t-3">
                ...
                <div class="card">
                    ...
                    <form class="form ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"></div>
                            <input class="form-control" value="{{ $mohon->nama }}" type="text" disabled>
                        </div>
                        </div>
                        <div class="form-group">
                        <label>No HP</label>
                ...
                <div class="col-lg-6">
                        {!! Form::open(['url' => route('admin.kontakkami.verifikasi'), 'method' => 'post', 'id' => 'kontakkami', 'files' => true]) !!}
                        <div class="card">
                            <div class="card-body">
                            <h4 class="text-black">Pesan</h4>
                            <label for="input-file-max-fs">Upload File Permintaan</label>
                            <textarea class="form-control" id="kontakkami" name="kontakkami" rows="7" disabled> {!! $mohon->pesan !!} </textarea>
                            ...
                            <input class="form-control" value="{{ $mohon->nopeserta }}" name="nopeserta" type="hidden">
                                <br/>
                                <ul>
                                    <li class="text-danger">Klik Submit untuk merubah status</li>
                                </ul>
                        </div>
                            @if ($errors->has('kontakkami')) <span class="text-danger">{{ $errors->first('kontakkami') }}</span> @endif
