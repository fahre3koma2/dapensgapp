...
<div class="content">
      ...
      <div class="card-body">
        ...
        <div class="row">
            <div class="col-lg-12 m-b-3">
              <h3 class="text-black"> Data Rekening </h3>
            </div>
            <!-- /.col -->
          </div>
            <div class="row ">
            <!-- /.col -->
              <div class="col-lg-6">
                 <h5 class="text-black"> Rekening Lama </h5>
              </div>
               <div class="col-lg-6">
                 <h5 class="text-black"> Rekening Baru </h5>
              </div>
                <div class="col-lg-6">
                <div class="table-responsive">
                    <table class="table">
        ...
        <div class="row ">
          ...
          <div class="row no-print">
            <div class="col-lg-12">
              <a href="{!! url('pensi/permohonanrekening') !!}" data-direction="next" style="margin-left: 5px;" class="btn btn-warning"><i class="fa fa-list-alt"></i> Tunda</a>

              <a href="{!! url('pensi/permohonan/rekening/form2', ['id' => encrypt($mohon->id )]) !!}" style="margin-right: 5px;" class="btn btn-info"><i class="fa fa-arrow-left"></i> Kembali</a>
              <button type="button" class="btn btn-primary pull-right finish" style="margin-right: 5px;" data-id="{{ $mohon->id }}" data-file="finish_{{ $mohon->id }}"> <i class="fa fa-credit-card"></i> Submit </button>
                {{ Form::open(['url' => route('pensi.permohonanrekening.kirim', [Crypt::encrypt($mohon->id)]), 'method' => 'post', 'id' => 'finish_'.$mohon->id ]) }}
                {{ csrf_field() }}
                {{ Form::close() }}
            </div>
          </div>
