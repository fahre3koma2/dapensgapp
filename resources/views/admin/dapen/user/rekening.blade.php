    <div class="card-body">
        ...
        @csrf
        <div class="row">
            @if($user->rekening->norekening == null)
            <div class="col-md-12">
        ...
        <div class="form-group has-feedback">
            ...
            <input class="form-control" type="text" value="{{ $user->rekening->norekening }}" disabled>
            <span class="fa fa-user-circle-o form-control-feedback" aria-hidden="true"></span> </div>
        </div>
        <div class="col-md-6">
        <div class="form-group has-feedback">
            <label class="control-label">Bank</label>
            <input class="form-control" type="text" name="name" value="{{ $user->rekening->bank }}" {{ $edit ? '' : 'disabled' }}>
            <span class="fa fa-user form-control-feedback" aria-hidden="true"></span> </div>
        </div>
        <div class="col-md-6">
        <div class="form-group has-feedback">
            <label class="control-label">Cabang</label>
            <input class="form-control" type="text" name="name" value="{{ $user->rekening->cabang }}" {{ $edit ? '' : 'disabled' }}>
            <span class="fa fa-user form-control-feedback" aria-hidden="true"></span> </div>
        </div>
        <div class="col-md-6">
        <div class="form-group has-feedback">
            <label class="control-label">An Bank</label>
            <input class="form-control" type="text" name="name" value="{{ $user->rekening->atasnama }}" {{ $edit ? '' : 'disabled' }}>
            <span class="fa fa-user form-control-feedback" aria-hidden="true"></span> </div>
        </div>
            @endif
        {{--  <div class="col-md-12">
