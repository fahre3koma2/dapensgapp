        ...
        {{--  <div id="demo">  --}}
          <div class="step-app">
                            ...
                            <td>
                                @if ($mohon->lampiran->file_surat_kematian)
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('file_surat_kematian_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-file_surat_kematian_-{{ $mohon->nopeserta }}">
                                            @csrf
                                            {{ Form::hidden('type', 'file_surat_kematian') }}
                                            {{ Form::hidden('idx', encrypt($mohon->id) ) }}
                                        </form>
                                @else
                                {!! Form::open(['url' => route('pensi.permohonan.upload'), 'method' => 'post', 'id' => 'file_surat_kematian', 'files' => true]) !!}
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($mohon->lampiran->file_surat_nikahortu)
                                    <a href="{{ url('dapen/lampiran/'.$mohon->nopeserta.'/'.$mohon->lampiran->file_surat_nikahortu) }}" title="download-view" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Lihat</a> |
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('file_surat_nikahortu_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-file_surat_nikahortu_-{{ $mohon->nopeserta }}">
                                            @csrf
                                            {{ Form::hidden('type', 'file_surat_nikahortu') }}
                                            {{ Form::hidden('idx', encrypt($mohon->id) ) }}
                                        </form>
                                @else
                                {!! Form::open(['url' => route('pensi.permohonan.upload'), 'method' => 'post', 'id' => 'file_surat_nikahortu', 'files' => true]) !!}
                                    <div class="form-group row">
                                        <div class="col-sm-8">
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($mohon->lampiran->file_foto)
                                    <a href="{{ url('dapen/lampiran/'.$mohon->nopeserta.'/'.$mohon->lampiran->file_foto) }}" title="download-view" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Lihat</a> |
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('file_foto_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-file_foto_-{{ $mohon->nopeserta }}">
                                            @csrf
                            ...
                            <td>
                                @if ($mohon->lampiran->file_ktp)
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('file_ktp_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-file_ktp_-{{ $mohon->nopeserta }}">
                                            @csrf
                           ...
                           <td>
                                @if ($mohon->lampiran->file_kk)
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('file_kk_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-file_kk_-{{ $mohon->nopeserta }}">
                                            @csrf
                        ...
                        <tr>
                           ...
                           <td>
                                @if ($mohon->lampiran->surat_kuasa)
                                    <a href="{{ url('dapen/lampiran/'.$mohon->nopeserta.'/'.$mohon->lampiran->surat_kuasa) }}" title="download-view" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Lihat</a> |
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('surat_kuasa_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-surat_kuasa_-{{ $mohon->nopeserta }}">
                                            @csrf
                                            {{ Form::hidden('type', 'surat_kuasa') }}
                                            {{ Form::hidden('idx', encrypt($mohon->id) ) }}
                                        </form>
                                @else
                                {!! Form::open(['url' => route('pensi.permohonan.upload'), 'method' => 'post', 'id' => 'surat_kuasa', 'files' => true]) !!}
                                    <div class="form-group row">
                                        <div class="col-sm-8">
                                            <label for="surat_kuasa">Silahkan Input File</label>
                                            <input class="form-control" type="hidden" name="type" value="surat_kuasa">
                                            <input class="form-control" type="hidden" name="valueid" value="{{ $mohon->nopeserta }}">
                                            <input class="form-control" type="hidden" name="idx" value="{{ encrypt($mohon->id) }}">
                                            <input type="file" name="surat_kuasa" id="surat_kuasa">
                                            @if ($errors->has('surat_kuasa')) <span class="text-danger">{{ $errors->first('surat_kuasa') }}</span> @endif
                                        </div>
                                        <div class="col-sm-4">
                                             <button type="submit" data-direction="next" class="btn btn-sm btn-info">Upload</button>
                                        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($mohon->lampiran->file_surat_sekolah)
                                    <a href="{{ url('dapen/lampiran/'.$mohon->nopeserta.'/'.$mohon->lampiran->file_surat_sekolah) }}" title="download-view" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Lihat</a> |
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('file_surat_sekolah_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-file_surat_sekolah_-{{ $mohon->nopeserta }}">
                                            @csrf
                                            {{ Form::hidden('type', 'file_surat_sekolah') }}
                                            {{ Form::hidden('idx', encrypt($mohon->id) ) }}
                                        </form>
                                @else
                                {!! Form::open(['url' => route('pensi.permohonan.upload'), 'method' => 'post', 'id' => 'file_surat_sekolah', 'files' => true]) !!}
                                    <div class="form-group row">
                                        <div class="col-sm-8">
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($mohon->lampiran->file_surat_penghasilan)
                                    <a href="{{ url('dapen/lampiran/'.$mohon->nopeserta.'/'.$mohon->lampiran->file_surat_penghasilan) }}" title="download-view" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Lihat</a> |
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('file_surat_penghasilan_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-file_surat_penghasilan_-{{ $mohon->nopeserta }}">
                                            @csrf
                                            {{ Form::hidden('type', 'file_surat_penghasilan') }}
                                            {{ Form::hidden('idx', encrypt($mohon->id) ) }}
                                        </form>
                                @else
                                {!! Form::open(['url' => route('pensi.permohonan.upload'), 'method' => 'post', 'id' => 'file_surat_penghasilan', 'files' => true]) !!}
                                    <div class="form-group row">
                                        <div class="col-sm-8">
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($mohon->lampiran->file_belum_nikah)
                                    <a href="{{ url('dapen/lampiran/'.$mohon->nopeserta.'/'.$mohon->lampiran->file_belum_nikah) }}" title="download-view" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Lihat</a> |
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('file_belum_nikah_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-file_belum_nikah_-{{ $mohon->nopeserta }}">
                                            @csrf
                                            {{ Form::hidden('type', 'file_belum_nikah') }}
                                            {{ Form::hidden('idx', encrypt($mohon->id) ) }}
                                        </form>
                                @else
                                {!! Form::open(['url' => route('pensi.permohonan.upload'), 'method' => 'post', 'id' => 'file_belum_nikah', 'files' => true]) !!}
                                    <div class="form-group row">
                                        <div class="col-sm-8">
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($mohon->lampiran->file_scan_anak)
                                    <a href="{{ url('dapen/lampiran/'.$mohon->nopeserta.'/'.$mohon->lampiran->file_scan_anak) }}" title="download-view" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Lihat</a> |
            ...
            <div class="step-footer">
                <a href="{!! url('pensi/permohonan/anak/form4', ['id' => encrypt($mohon->id )]) !!}" type="submit" data-direction="next" class="btn btn-primary">Next</a>
        </div>
            </div>
          </div>
        {{--  </div>  --}}
