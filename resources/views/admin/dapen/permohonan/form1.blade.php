...
<div class="content">
      ...
      <div class="card-body">
        ...
        @if ($mohon)
        dd($moho)
        {!! Form::model($mohon, ['route' => ['pensi.permohonan.update', encrypt($mohon->id)], 'method'=>'patch']) !!}
        @else
        {{ Form::open(['url' => route('pensi.permohonan.store'), 'method' => 'post', 'id' => 'mohon']) }}
        @endif
        @csrf
            <div class="row m-t-2">
            <div class="col-md-6">
            ...
            <div class="col-md-12">
                <div class="form-group">
                <label>Alamat :</label>
                <textarea name="shortDescription" id="shortDescription1" rows="2" class="form-control" name="alamat" required>{{ $user->biodata->alamat }}</textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
