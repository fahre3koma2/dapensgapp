        ...
        {{--  <div id="demo">  --}}
          <div class="step-app">
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($mohon->lampiran->file_skperusahaan)
                                    <a href="{{ url('dapen/lampiran/'.$mohon->nopeserta.'/'.$mohon->lampiran->file_skperusahaan) }}" title="download-view" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Lihat</a> |
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('file_skperusahaan_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-file_skperusahaan_-{{ $mohon->nopeserta }}">
                                            @csrf
                            ...
                            <td>
                                @if ($mohon->lampiran->file_npwp)
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('file_npwp_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-file_npwp_-{{ $mohon->nopeserta }}">
                                            @csrf
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($mohon->lampiran->file_tabungan)
                                    <a href="{{ url('dapen/lampiran/'.$mohon->nopeserta.'/'.$mohon->lampiran->file_tabungan) }}" title="download-view" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Lihat</a> |
                                    <button type="button" class="btn btn-sm btn-danger" onclick="return hapusFile('file_tabungan_-'+'{{ $mohon->nopeserta }}')"><i class="fa fa-trash"></i> Hapus</button>
                                        <form action="{{ route('pensi.permohonan.deletefile', ['id' => $mohon->nopeserta]) }}" method="post" id="file-file_tabungan_-{{ $mohon->nopeserta }}">
                                            @csrf
            ...
            <div class="step-footer">
                <a href="{!! url('pensi/permohonan/karyawan/form3', ['id' => encrypt($mohon->id )]) !!}" type="submit" data-direction="next" class="btn btn-primary">Next</a>
        </div>
            </div>
          </div>
        {{--  </div>  --}}
