...
@section('breadcrumb')
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> Konten Beranda</li>
      </ol>
    </div>
@endsection
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header bg-blue">
              <h5 class="m-b-0">Edit Beranda</h5>
            </div>
            <div class="card-body">
                  <form class="form-horizontal" action="{{ $edit ? route('admin.updateberanda', ['id' => encrypt($konten->id)]) : route('admin.artikel.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal form-bordered">
                    @if ($edit)
                        {{ method_field('PUT') }}
                    @endif
                    @csrf
