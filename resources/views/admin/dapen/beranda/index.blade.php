        ...
        <div class="box-body">
            ...
            <div class="d-flex">
                <div class="align-self-center">
                    <h4 class="text-black m-b-1">Konten Beranda </h4>
                </div>
            </div>
            </div>
            ...
            <table id="example2" class="table table-bordered table-hover no-wrap">
                ...
                @foreach ($konten as $item)
                    <tr>
                        ...
                        <td>{{ $item->kategori }}</td>
                            <td><a href="{!! route('admin.editberanda', ['id' => encrypt($item->id)]) !!}" type="button" class="btn btn-default"> <i class="icon-note" aria-hidden="true"></i> </a></td>
                    </tr>
                @php $no++; @endphp
                @endforeach
            </table>
