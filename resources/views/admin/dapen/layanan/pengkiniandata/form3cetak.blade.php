...
<div class="content">
      ...
      <div class="card-body">
        ...
        <div class="row ">
            @include('admin.dapen.layanan.cetakpengkiniandata');
        </div>
        ...
        <div class="row ">
          ...
          <div class="row no-print">
            <div class="col-lg-12">
              ...
              <a href="{!! url('pensi/permohonan/karyawan/form2', ['id' => encrypt($user->id )]) !!}" style="margin-right: 5px;" class="btn btn-info"><i class="fa fa-arrow-left"></i> Kembali</a>
              <button type="button" class="btn btn-primary pull-right finish" style="margin-right: 5px;" data-id="{{ $user->id }}" data-file="finish_{{ $user->id }}"> <i class="fa fa-credit-card"></i> Submit </button>
                {{ Form::open(['url' => route('pensi.permohonan.kirim', [Crypt::encrypt($user->id)]), 'method' => 'post', 'id' => 'finish_'.$user->id ]) }}
                {{ csrf_field() }}
                {{ Form::close() }}
            </div>
          </div>
