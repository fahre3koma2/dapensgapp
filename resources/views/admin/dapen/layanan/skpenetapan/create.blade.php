        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header bg-blue">
              <h5 class="m-b-0">Permintaan SK Penetapan</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('pensi.skpenetapan.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal form-bordered">
                    @if ($edit)
                        {{ method_field('PUT') }}
                    @endif
                    @csrf
