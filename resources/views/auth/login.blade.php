...
<div class="login-box sty1">
  ...
  <div class="login-logo">
    <a href="index.html"><img src="{{ url('dist/img/logo-blue.png') }}" alt=""></a>
  </div>
    <p class="login-box-msg">Sign in to start your session</p>
    <form action="http://uxliner.com/adminkit/demo/material/ltr/index.html" method="post">
    ...
    <div class="m-t-2">Dont have an account? <a href="pages-register2.html" class="text-center">Sign Up</a></div>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
...
<!-- template -->
<script src="{{ url('dist/js/niche.html') }}"></script>
</body>
